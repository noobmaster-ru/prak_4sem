...
task3:
    Цель – Придумать иерархию классов на любую тему с абстрактным классом в основе 
        и наличием минимум одной чистой виртуальной функцией. 
    Иерархия классов должна включать минимум один класс с множественным наследованием.

    Средство – язык С++
    
    абстрактный класс - device
    ромбовидное наследование computer -> device, telephone -> device , smartphone -> computer,telephone
