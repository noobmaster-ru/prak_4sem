...
int main (int argc, char* argv[]) {
    ...
    while (end_of_work == 0){
        ...
        write(client_socketfd,command_buffer,sizeof(command_buffer));
        ...
        if (command_buffer[0] == '+'){
            ...
            if (return_status > 0) {
                printf("global_increase_parameter = %d\n", ntohl(received_int));
            }
            else {
                // Handling erros here
            ...
            return_status = read(client_socketfd, &received_int, sizeof(received_int));
            printf("num1 + num2 + glob = %d\n", ntohl(received_int));
        }

        // receive number_increase_parameter
        ...
        // set number_increase_parameter
            ...
            number_of_received_bytes = read(client_socketfd, buf, sizeof(buf));
