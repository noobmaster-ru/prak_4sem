...
/* FILE MAGIC - этот текст записывается в начало файла данных */
...
struct TableInfo {
        long dataOffset;
        long fieldNumber; /* дублирует pFieldStruct->numOfFields */
        long recordSize;
        long totalRecordNumber; /* включая удаленные записи */
        long recordNumber;
...
char* ErrorText[]=
           { "Успех.",
             ...
             "Поле не найдено.",
             "Неверный дескриптор таблицы",
             "Неверные аргументы",
             "Не удалось установить позицию в файле",
             "Ошибка записи в файл",
             "Ошибка чтения файла",
             "Данные таблицы повреждены",
             "Не удалось создать дескриптор таблицы",
             "Не удалось удалить или открыть файл только для чтения",
             "Недопустимое имя файла",
             "Не удалось удалить таблицу",
             "Данные файла повреждены",
             "Неверная позиция в файле",
             "Неверный тип поля",
             "Текстовое значение превышает длину поля",
             "Текущая запись не редактируется",
             "Неверная позиция"
          };
